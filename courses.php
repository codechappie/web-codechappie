...
<html lang="en" class="no-js">
  <head>
    ...
    <!-- Modernizr -->
		...
		<title>Cursos - Code Chappie</title>
  ...
  <body class="foo">
    ...
    <section class="course-container">
      <div class="container">
        ...
        <input type="search" name="searcher_input" spellcheck="false" id="searcher_input" placeholder="Buscar cursos...">
          </div>
      </div>
        <div class="curses">
          <a href="#" class="curso">
		...
		<div class="btn-courses">
			<button>Cargar más cursos</button>
		</div>
      </div>
	</section>
	<footer>
